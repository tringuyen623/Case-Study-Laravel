        ...
        if (request()->ajax()) {
            return DataTables::of($galleryCategory)
                ->addColumn('action', function ($galleryCategory) {
                    ...
                    ' .
                        '<button type="button" class="btn btn-outline-danger delete-gallery-category" data-toggle="modal" data-target="#confirm-modal" data-id ="' . $galleryCategory->id . '"><i
    ...
    public function getDeletedData()
    {
        ...
        if (request()->ajax()) {
            ...
            class="fa fa-undo"></i></button>' .
                        '<button type="button" class="btn btn-outline-danger delete-gallery-category" data-toggle="modal" data-target="#confirmModal" data-id ="' . $deletedGalleryCategory->id . '"><i
            class="fa fa-trash"></i></button>
            </div>';
                })
                ->make(true);
